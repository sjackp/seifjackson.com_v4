            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <span
                    key={index}
                    className="px-4 py-2 bg-gradient-to-r from-orange-accent to-orange-light dark:text-black rounded-full text-sm font-geist font-semibold smooth-hover scale-hover glow-hover cursor-pointer button-click text-[#000000]"
                  >
                    {skill}
                  </span>
                ))}
