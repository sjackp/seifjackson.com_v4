        ...
        <div className="bg-dark-accent/30 backdrop-blur-xl rounded-2xl border border-dark-accent/40 p-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-orange-accent to-orange-light text-black rounded-xl font-bold font-geist smooth-hover scale-hover glow-hover button-click transition-colors duration-500"
            >
